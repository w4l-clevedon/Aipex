...
define('AIPEX_PODCAST_VERSION','2.2.7');
...
require_once AIPEX_PODCAST_DIR.'includes/class-context-fixes.php';
...
add_action('plugins_loaded', ['Aipex_Podcast_Context_Fixes','init'], 20);
